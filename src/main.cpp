...
int main() {
    ...
    astronauts.add(new Astronaut("Sonia", "111.111.111-11", FEMALE, 18));
    Astronaut* b = new Astronaut("Alice", "222.222.222-22", FEMALE, 18);
    astronauts.add(b);
    b->available = false;
    astronauts.add(new Astronaut("Carla", "111.111.111-11", FEMALE, 18));
    astronauts.add(new Astronaut("Genia", "111.111.111-11", FEMALE, 18));
    ...
    astronauts.add(c);
    c->kill();
    Astronaut* d = new Astronaut("Berna", "222.222.222-22", FEMALE, 18);
    astronauts.add(d);
    d->kill();
